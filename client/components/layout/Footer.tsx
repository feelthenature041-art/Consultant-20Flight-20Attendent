...
export function Footer() {
  return (
    <footer className="border-t bg-white">
      <div className="container mx-auto max-w-[80%] py-10 grid gap-8 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground max-w-xs">
            Real professionals. Real guidance. Real careers.
          </p>
        </div>
        <div>
      ...
      <div className="border-t">
        <div className="container mx-auto max-w-[80%] py-6 flex items-center justify-between text-xs text-muted-foreground">
