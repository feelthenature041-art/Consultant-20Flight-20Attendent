...
export const mentors: Mentor[] = [
  {
    ...
    cover:
      "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2F023d61d59f26431b84f049e30bad2e5c?format=webp&width=1200",
    ...
    reviews: [
      { name: "Vikram", rating: 5, text: "Great language guidance and tips." },
    ],
  ...
  },
  {
    ...
    cover:
      "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2Fc8a9168c6baf4de4b9e7422e08192a64?format=webp&width=1200",
    ...
    outcomes: [
      "Roadmap PDF after call",
      "Interview question bank",
      "Checklist for medical & docs",
    ],
    sampleQuestions: [
    ...
    reviews: [
      {
        name: "Sanya",
        rating: 5,
        text: "Got a 3-month roadmap and passed my first interview!",
      },
      {
        name: "Priya",
        rating: 5,
        text: "Clear tips on grooming and resume. Super helpful.",
      },
    ],
    policies: [
      "24h reschedule",
      "Refunds if mentor no-show",
  ...
  },
  {
    ...
    cover:
      "https://cdn.builder.io/api/v1/image/assets%2F728d0307159d4db0b6c1744ba0b9e3d6%2F3f6980e7e3064328bb5737047c62b163?format=webp&width=1200",
    bio: "Trainer for domestic and international crew. Focus on interview performance and service excellence.",
    specialties: [
      "Assessment day coaching",
      "Resume review",
      "Onboard etiquette",
    ],
    outcomes: ["Personalized prep plan", "Mock interview feedback"],
    sampleQuestions: [
      "How to stand out on assessment day?",
    ...
    reviews: [
      {
        name: "Aman",
        rating: 5,
        text: "Arjun's mock interview felt real. I gained a lot of confidence.",
      },
    ],
