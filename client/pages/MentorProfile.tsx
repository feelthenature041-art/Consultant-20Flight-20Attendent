...
export default function MentorProfile() {
  ...
  if (!m)
    return (
      <section className="container mx-auto max-w-[90%] md:max-w-[80%] py-16">
        <p>Mentor not found.</p>
      </section>
    );

  return (
    <section className="container mx-auto max-w-[90%] md:max-w-[80%] py-10 md:py-16 grid gap-8 lg:grid-cols-[1fr_360px]">
      <div>
